...
/**
 * ========= Search Transactions for Period order by Date =========
 *
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        WHERE transactions.transaction_datetime BETWEEN :from_date AND :to_date 
...
<head>
    ...
    <title>Search Bank Trnsactions</title>
...
<body>
    ...
    <div class="page">
        <h1>Search Bank Trnsactions</h1>

        <div class="breadcrumb">
            <a href="/">home</a>
            <span>></span> Search Bank Trnsactions
        </div>
        ...
        <div class="form-card form-card--horizontal">
            <h2>Search Bank Transactions for Period</h2>
            
            <form action="trans_query.php" method="POST">
